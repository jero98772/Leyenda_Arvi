...
class configMap:
    ...
    def genMapMultlayer(self,fileName,layers:list):
        view = pdk.ViewState(latitude=6.268881044071327, longitude= -75.49672372106615, pitch=40, zoom=12)
...
for i in range(10):
    ...
    data.append([d1,d2])
my_points=[[6.268881044071327, -75.49672372106615],[6.265695702561827, -75.4951161823077],[6.268923631330613, -75.49412205704012],[6.266563029351161, -75.4965374219183],[6.266710674021357, -75.49431480119169]]
